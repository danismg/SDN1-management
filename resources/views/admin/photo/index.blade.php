...
@section('content')
    ...
    <section style="margin-top: 100px">
        <div class="container col-xxl-8 py-5">
            <h4 class="fw-bold mb-3">Management Photo</h4>

            <a class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#uploadModal">Upload Photo</a>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach ($photos as $item)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td><img src="{{ asset('storage/photo/' . $item->image) }}" height="150" alt="">
                                </td>
                                <td>
                                    {{ $item->judul }}
                                </td>
