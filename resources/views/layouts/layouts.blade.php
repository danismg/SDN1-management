            ...
            <footer>
                <div class="row">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <ul class="nav flex-column me-5">
                            <li class="nav-item mb-2"><a href=""
                                    class="nav-link p-0 text-muted">SDN173551LAGUBOTI@GMAIL.COM</a></li>
                            <li class="nav-item mb-2"><a href=""
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <p>jln ahmad yani , desa pasar lagubotu, kecamatan laguboti, kabipaten toba, provisnsi Sumatera
                            utara</p>
                    </div>
                </div>
            </footer>
